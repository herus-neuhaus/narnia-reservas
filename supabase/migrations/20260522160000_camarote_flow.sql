-- Migration for Camarote Flow fixes
-- 1. Modify create_reservation_v2 to insert into camarotes table when type = 'camarote'
...
-- 2. Create RPC `register_camarote_guest_entry`
...
-- 3. Create RPC `authorize_camarote_extra_entry`
