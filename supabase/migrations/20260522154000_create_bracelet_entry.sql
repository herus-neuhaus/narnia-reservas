-- Add ticket_batch_id to reservations
ALTER TABLE public.reservations ADD COLUMN IF NOT EXISTS ticket_batch_id UUID REFERENCES public.ticket_batches(id);

-- Create RPC for Bracelet Entry
