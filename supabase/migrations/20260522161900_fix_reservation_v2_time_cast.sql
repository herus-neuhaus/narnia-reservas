-- Fix time cast in create_reservation_v2
...
BEGIN
  ...
  -- 5. Verificar Disponibilidade de Mesa ou Camarote
  ...
  -- 6. Verificar Limite da Lista de Convidados
  ...
  -- 9. Se for camarote, criar na tabela camarotes
